...
// Keep the full SSR output including the $_TSR router hydration script.
// TanStack Router requires $_TSR to be present — removing it causes an
// "Invariant failed" crash during client-side initialization.
// The original "d.find is not a function" error was caused by campus.tsx
// calling .find() on a non-array server response, which is now guarded
// by the Array.isArray() check in src/lib/campus.tsx.
