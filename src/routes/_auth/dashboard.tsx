...
import {
  IndianRupee, AlertCircle, CalendarClock, Users,
  UserPlus, Receipt, Search, AlertTriangle,
} from "lucide-react";
                  ...
                  <tbody className="divide-y divide-border">
                    {recent.data.map((p: any) => (
                      <tr key={p.id}>
                        ...
                        <td>
                          {p.student_id ? (
                            <Link to="/students/$studentId" params={{ studentId: p.student_id }} className="hover:underline">{p.student_name}</Link>
                          ) : p.student_name}
                        </td>
